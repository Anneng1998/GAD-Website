...
if(isset($_POST['login'])) {
    ...
    if (empty($email) && empty($pass)){
        echo "<script>alert('Complete all fields');window.location.href = 'login.php';</script>";  
    }else{
        ...
        if ($check_account_num == 1){
            ...
            echo "<script>alert('Username and Password does not match');window.location.href = 'login.php';</script>";
        }
