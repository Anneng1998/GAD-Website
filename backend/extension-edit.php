                ...
                <div class="mb-3">
                    ...
                    <div class ="row">
                        <div class="col-6">
                            ...
                            <input type="text" name="Dfrom" id="simpleinput" class="form-control" value="<?php echo $edit_qry_fetch['fldDFrom']?>" required>
                        </div>
                        <div class="col-6">
                        <label for="simpleinput" class="form-label">To</label>
                            <input type="text" name="Dto" id="simpleinput" class="form-control" value="<?php echo $edit_qry_fetch['fldDTo']?>" required>
                        </div>
                    </div>
                </div>
