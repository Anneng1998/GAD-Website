...
if(isset($_POST['mediaupload'])){
    ...
    if($title == "" || $component == "" || $duration == "" || $budget == "" || $fund == "" || $research == ""){
        ...
        $insert_research = "INSERT INTO tbl_basedresearch (fldUID, fldTitle, fldDescription, fldResearch, fldDuration, fldBudget, fldFund, fldProposal, fldHgdg, fldPaper, fldPIMME, fldStatus, fldFrom) VALUES ('$UniqueID', '$title', '$component', '$research', '$duration', '$budget', '$fund', '$Proposal_new_name', '$HGDG_new_name', '$paper_new_name', '$PIMME_new_name', 'unarchive', 'tbl_basedresearch')";
