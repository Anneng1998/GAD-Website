<?php 
    ...
    if ($from == 'tbl_media') {
        ...
        $update_query = mysqli_query($db, "update tbl_news set statuss = 'unarchive' WHERE fldUID = '$id'");

    } elseif ($from == 'tbl_events') {

        $update_query = mysqli_query($db, "update tbl_events set statuss = 'unarchive' WHERE fldUID = '$id'");
    }
