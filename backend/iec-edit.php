<div id="edit<?php echo $iec_data['fldID'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-primary">
                <h4 class="modal-title" id="primary-header-modalLabel">EDIT IEC MATERIALS</h4>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                        ...
                        <select class="form-select" name="categories" id="example-select" value="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="simpleinput" class="form-control" value="<?php echo $edit_qry_fetch['fldtitle']?>">
                </div>

                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Description</label>
                    <input type="text" name="description" id="simpleinput" class="form-control" value="<?php echo $edit_qry_fetch['fldDescription']?>">
                </div>
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control date" name="date" id="birthdatepicker" data-toggle="date-picker" data-single-date-picker="true" value="<?php echo $edit_qry_fetch['fldDate']?>">
                </div>
