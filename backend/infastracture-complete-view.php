<div id="cview<?php echo $infastracture_data['fldID'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control date" name="targetcompletion" id="birthdatepicker" data-toggle="date-picker" data-single-date-picker="true" value="<?php echo $infastracture_data['fldDateCompleted']?>" disabled>
                        </div>
                    </div>
                ...
                <!-- <div class="row"> -->
                    ...
                    <div class="col-6">
                        <h6>Report</h6>
                        <a class="btn btn-danger btn-sm form-control" href="files/infastracture/<?php echo $infastracture_data['fldReport'] ?>" target="_blank">
                            <?php echo $infastracture_data['fldReport'] ?>
                        </a>
                    </div>
                <!-- </div> -->
