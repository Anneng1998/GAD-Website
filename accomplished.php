 ...
 <div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">GAD ACCOMPLISHED REPORT</h4>
        </div>
    </div>
</div>     
<!-- end page title -->
...
<table id="alternative-page-datatable" class="table dt-responsive nowrap">
    ...
    <tbody>
        <?php
            $media_query = mysqli_query($db, "Select * from tbl_accomplished where fldStatus = 'unarchive' order by fldID");
        ...
        <tr>
            ...
            <td>
                ...
                <a href="download/download-accomplished.php?id=<?php echo $research_data['fldID'] ?>" class="btn btn-success shadow btn-xs sharp me-1"><i class="dripicons-download"></i></a>
            </td>
        </tr>
        <?php
...
<?php 
include 'backend/accomplished-upload.php';
